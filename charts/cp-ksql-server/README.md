...
```console
helm install --set cp-kafka.bootstrapServers="PLAINTEXT://unhinged-robin-cp-bootstrap-server:9092",cp-schema-registry.url="http://lolling-chinchilla-cp-schema-registry:8081" cp-helm-charts/charts/cp-ksql-server
```
